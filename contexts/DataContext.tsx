...
export const DataProvider: React.FC<{ children: ReactNode }> = ({
  ...
  const projectsMemo: Project[] = useMemo(() => {
    ...
    return mgmtProjects.map((mp) => ({
      ...
      risk_flag: mp.risk_level === 'High', // Example mapping
      risk_note: '',
  ...
  const addPerson = useCallback(
    async (person: Omit<Person, 'user_id'>) => {
      ...
      const newSystemPerson: Omit<SystemPerson, 'user_id'> = {
        ...
        // as it is being mapped to SystemPeople.
        ...
        annual_comp_inr: person.annual_comp_inr ?? 0,
        capacity_utilization_pct: person.capacity_utilization_pct ?? 0,
        ...
        weekly_hours_capacity: person.weekly_hours_capacity ?? 0,
