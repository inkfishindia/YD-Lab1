...
const tabs = [
    { name: 'BU Performance', href: 'performance' },
    { name: 'BU Detail (Deep Dive)', href: 'detail' },
    { name: 'BU Maturity Tracker', href: 'maturity' },
];

const BusinessUnitsTabs: React.FC = () => {
...
export default BusinessUnitsTabs;
